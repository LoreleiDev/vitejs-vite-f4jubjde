                    ...
                    <Link to="/contact" className="select-none flex-1 relative group overflow-hidden">
                        ...
                        <div className="relative z-10 flex items-center justify-center h-full text-center px-3">
                            <div className="transform transition-all duration-500 group-hover:scale-105">
                                ...
                                <div className="inline-flex items-center gap-1.5 px-4 py-1.5 bg-white text-[#5B23FF] rounded-lg text-xs md:text-sm font-poppins font-semibold shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:gap-2.5  hover:text-white">
                                    Pesan Sekarang
